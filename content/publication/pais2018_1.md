...
abstract_short = """
In this work, we present a hybrid approach between two statistical methods to identify the language of a written text. In particular, we propose an effective approach that can be trained with a small corpus of any source (including noisy short texts).
"""
